...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <%-- tuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu zmienic action
        ...
        <div data-step="1" class="active">
            ...
            <div class="form-group form-group--checkbox">
                <label>
                    ...
                    <label>
                        <input type="checkbox" name="categories" th:th:value="${category.id}"/>
        ...
        <div data-step="3">
            ...
            <div class="form-group form-group--checkbox" th:each="institution : ${institutions}">
                <label>
                    <input type="radio" name="organization" th:value="${institution.id}"/>
    ...
    <div data-step="4">
        ...
        <div class="form-section form-section--columns">
            <div class="form-section--column">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Numer telefonu <input type="phone" th:field="phone"/>
                    </label>
                </div>
            </div>
            ...
            <div class="form-section--column">
                ...
                <div class="form-group form-group--inline">
                    <label> Godzina <input type="time" th:field="pickUuTime"/> </label>
                </div>
        ...
        <div class="summary">
            <div class="form-section">
                ...
                <ul>
                    ...
                    <!-- Pozostałe elementy podsumowania -->
                </ul>
            </div>
            ...
            <div class="form-section form-section--columns">
                <div class="form-section--column">
                    ...
                    <ul>
                        ...
                        <li>
                            <span th:text="${donation.phone}"></span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="form-section--column">
                    ...
                    <ul>
                        ...
                        <li>
                            <span th:text="${donation.pickUpTime}"></span>
                        </li>
                        <li>
                            <span th:text="${donation.pickUpComment}"></span>
                        </li>
                    </ul>
                </div>
            </div>
